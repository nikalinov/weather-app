...
function displayWeatherInfo(response) {
    ...
    document.querySelector("#current-temperature").innerHTML = `${temperature}\xb0`;
...
async function setPicture(city) {
    const promise = await fetch(`https://api.unsplash.com/search/photos/?client_id=Z2pRlKiwrqZYJQbwMytFxXzOWQF0ggPOCQQsuuecHic&query=${city}&page=1&w=500&h=500`);
